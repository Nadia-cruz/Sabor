            ...
            <nav class="navbar navbar-inverse" role="navigation">
                ...
                <div id="main-nav" class="collapse navbar-collapse">
                    <ul class="nav navbar-nav">
                        ...
                        <li><a href="carrinho.php"><i class="fa fa-shopping-cart" style="font-size:20px"><span><?php echo $cart_count; ?></span></i></a></li>
			...
			<div class="table-responsive">
				<table class="table table-hover">
					...
					<tr>
						...
						<td  align="center">
						<input class="btn btn-outline-light text-dark" type="submit" name="Validar" value="Finalizar Pedido" /> 
